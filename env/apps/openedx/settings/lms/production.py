...
MEILISEARCH_API_KEY = "23e9d87afd850f8258cb71f6a580292688e12594e3cffbc5f7a7249ed1232103"
MEILISEARCH_MASTER_KEY = "aPAjrPFaNCSKF6vIRy2RRpQe"
...
# Contact addresses
CONTACT_MAILING_ADDRESS = "ICS 401-A edX - http://local.openedx.io"
...
JWT_AUTH["JWT_SECRET_KEY"] = "5FANuWOsCLM9frK4K2D17OOo"
JWT_AUTH["JWT_PRIVATE_SIGNING_JWK"] = json.dumps(
    {
        "kid": "openedx",
        "kty": "RSA",
        "e": "AQAB",
        "d": "Ax7nvzP46-VGsaASPXrqk-R2HBQA2wicQQ6Z7V0aayxatZXJjEvhsvAJUxlepltUNde7eAHWjHx-KAGwDZsB_IbHHVVSmT5vA7BlQeFLia3cQcD_w0MKaMvTuyxEcU-oeusxVuTONlTMMN9AvnmenT4FTm_-YtDOY6q7Fce-kSIRY-NHBVYMnF3CB6kGSWvpb7Tid7WCaZgdek_-qsBUWL9Ad_se4VUmNhEOcIrnRHXL5L3g2sZAXA683piKbK-TXGuUXadAtoNdNqM7PAzt66D-EEwU-UIi7_TTzVaS9dj9wxEzKgszxVOOABCx084IAVuE-3OyiVd4-sMWdyzH2Q",
        "n": "kNdh-v5fpioQbajMMn1HMGwJP734UIUZKEGZyz-Ca4Cjn10f3O6jSANlsGPFfIepQkirlKIB9UbHdyclJC8h3rGN30GBQ41LYaEewhrvAVUnolVHAOWQ5VK5T7oskw8LWoddCc7EUVFb3_2rI2Jh_NE2bdNO-fUDODlOKZ_NiLlVWi6k2mEHuKBQq6YQUxUFiNcE-IOgHgZAISRv0GpNGvfIkVb_4wiSech5hEdzBs90I-oBBVcUIsBmEsPxZKs8P5EuyWpgrFws5Wueocy0nMEyo8S-6qVTj7ZtKtMbsz-BgaYu23KeWVyLy1IgeBDWHIfBskAzPtQNX0hR6dHukw",
        "p": "tY8sFp7GvKB8yucZZsKn3iUZBvl1-_7qaCZLgAEKFk0g0cuo0jHP-0-xoUTfVPRGShDC3kvUmnz7QuqDtuk0Icwip0lEjdTHhYkmRSeIdTLylSP1yQuxf9Vbp0W9pi02UQASoZBJ-lT44YYoHiJI66H7VMocpdWfFx4RcHkl7YU",
        "q": "zDo4-oCucbaCGuHSyDeqxNDim8XAFZpxG_mdD4gBgeqMfU3doDLMxowhi19s6t0M3Chc4aIGg0colm-oyjocqYMjPlXRvS5C3oshAEWDk9KI7GWzgD4PxZHoVzjM_WBwQRR1sxa0w902nBXveDv-SaQVKB9qMyt17ct64KZpezc",
        "dq": "WZ6HGG5VnrLfPxqv24qKFpovhvntQ82lKwiLgqBFQRSDGA2OXtlMASjHI5j5e8sK9KWFtMHcJ8mXJwTSxgNgRoa0dYtFYcYmM_BLyAm5JqoxycMLVRBm7WUM1xGm6t1iBT0MNU2Wf4jYiQAbOODiwsANRLEccl30_yfWwTRlf1s",
        "dp": "fitTgRivlQ-WCU7VySKGk4qGPOGIyyjX7q6GExslzl-k6gY0eHWjScqU7zQ0Ww4x9nB1axOZWA54cYUVKTwgPUhl4Ii6-jEewj6P-MjDPGa-S0QlHqRgoiw7uB9v7pZGw71gNSRXNH5uQhL_uAktUYpMZRzbEadFGkSL6_RUlh0",
        "qi": "PClIWVHgIi-zSUMlH0hqxg9yz9Z9DmuiDji52XnBmq5L6AfCodVv5c1uOpAL6l1jvi2CBfzVjzOsKw4HKorQxhdw_z95PuR3pyemfJHQNWOlE_jq0lubdNSvinTPUWaIH4oNQbMRly67MGfnrGlgJomObskK1n7Xqszi7QwBzk4",
    }
)
...
JWT_AUTH["JWT_ISSUERS"] = [
    {
        ...
        "AUDIENCE": "openedx",
        "SECRET_KEY": "5FANuWOsCLM9frK4K2D17OOo"
    }
]
...
MFE_CONFIG = {
    ...
    "INFO_EMAIL": "tonettedevera061405@gmail.com",
    ...
    "PASSWORD_RESET_SUPPORT_LINK": "mailto:tonettedevera061405@gmail.com",
    "REFRESH_ACCESS_TOKEN_ENDPOINT": "http://local.openedx.io/login_refresh",
    "SITE_NAME": "ICS 401-A edX",
...
ADMIN_CONSOLE_MICROFRONTEND_URL = "http://apps.local.openedx.io/admin-console"
